...
import src.zephyr
from src.zephyr.collector import MeasurementCollector
from src.zephyr.bioharness import BioHarnessSignalAnalysis, BioHarnessPacketHandler
from src.zephyr.delayed_stream import DelayedRealTimeStream
from src.zephyr.message import MessagePayloadParser
from src.zephyr.protocol import BioHarnessProtocol, MessageFrameParser
from src.zephyr.hxm import HxMPacketAnalysis
...
class TimedVirtualSerial:
    ...
    def read_byte(self):
        ...
        time_to_chunk_timestamp = chunk_timestamp - src.zephyr.time()
        
        if time_to_chunk_timestamp > 0:
            src.zephyr.sleep(time_to_chunk_timestamp)
...
def simulation_workflow(callbacks, ser):
    src.zephyr.configure_root_logger()
